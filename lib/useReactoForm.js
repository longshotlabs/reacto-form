...
export default function useReactoForm(props) {
  ...
  return {
    formData,
    getInputProps(fieldPath, { isForm, nullValue, propNames = {} } = {}) {
      ...
      function onInputValueChange(arg1) {
        // The spec calls for new value to be passed as the first arg, but many popular libraries pass
        // an Event as the first arg, so we'll handle that gracefully.
        const inputValue = (arg1 && arg1.target) ? arg1.target.value : arg1;
      ...
      function onInputValueChanging(arg1) {
        // The spec calls for new value to be passed as the first arg, but many popular libraries pass
        // an Event as the first arg, so we'll handle that gracefully.
        const inputValue = (arg1 && arg1.target) ? arg1.target.value : arg1;
