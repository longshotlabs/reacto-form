...
exports.default = getDateFromDateTimeValues;
...
function getDateFromDateTimeValues(obj, moment, timezone) {
  if (!moment || typeof timezone !== "string") return null;
  var dayValue = obj.dayValue,
      monthValue = obj.monthValue,
      timeValue = obj.timeValue,
      yearValue = obj.yearValue;
